...
def param_cfg_cpt():
    ...
    params = [(os.path.join(pytest.CODEB_PATH, "configs/restorers/esrgan/esrgan_x4c64b23g32_g1_400k_div2k.py"),
               utils.get_cpt(file_path="configs/restorers/esrgan/esrgan_x4c64b23g32_g1_400k_div2k.py",
...
def test_image_demo(cfg_cpt):
    ...
    file_path = os.path.join(pytest.CODEB_PATH, 'demo/restoration_demo.py')
    # the cmd to be executed

    cmd = "python" + " " + file_path + " " \
          + cfg_cpt + " " \
          + os.path.join(pytest.CODEB_PATH, "tests/data/lq/baboon_x4.png") + " " \
          + os.path.join(pytest.CODEB_PATH, "demo/demo_out_baboon.png")

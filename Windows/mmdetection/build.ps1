...
function InstallPackage() {
    ...
    try {
        Write-Host "pip uninstall mmdet"
        ...
        Write-Host "Start conda create -y -n $tmpEnv --clone $mmcvEnv"
